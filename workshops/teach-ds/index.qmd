...
Topics will cover teaching the tidyverse in 2023, highlighting updates to the 2nd edition of *R for Data Science* as well as the tidyverse in general that should be reflected in today's data science curricula as well as present tooling options and workflows for reproducible authoring, computing infrastructure, version control, and collaboration.
