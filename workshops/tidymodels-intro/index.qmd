...
[**Hannah Frick**](https://www.frick.ws/) is a software engineer and statistician on the tidymodels team at Posit.
...
[**Simon Couch**](https://www.simonpcouch.com/) works on software for statistical modeling on the tidymodels team at Posit.
...
[**Emil Hvitfeldt**](https://www.emilhvitfeldt.com/) is a software engineer at Posit and part of the tidymodels team's effort to improve R's modeling capabilities.
He maintains several packages within the realms of modeling, text analysis, and color palettes.
He co-authored the book *Supervised Machine Learning for Text Analysis in R* with Julia Silge.
