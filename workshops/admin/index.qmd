...
|                          |     |                                                                                                                                                                                                                                                                                     |
|--------------|--------------|--------------------------------------------|
| ![](shannon-hagerty.png) |     | **Shannon Hargerty** is a Solutions Engineer at Posit, where she helps organizations determine how to optimize their configuration and use of the Posit Products for their use case. Before coming to Posit, Shannon earned a Ph.D. in Ecology and taught R and Python researchers. |
