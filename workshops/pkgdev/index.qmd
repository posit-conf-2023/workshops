...
In R, the fundamental unit of reusable code is a package, containing helpful functions, documentation, and sometimes sample data.
...
If you are looking to get started with Git and GitHub, we recommend you register for the ["What they forgot to teach you about R"](https://posit-conf-2023.github.io/workshops/workshops/wtf/) workshop on Day 1, and join us for this workshop on Day 2.

# Instructor

|                  |     |                                                                                                                                                                                                                                                                                                   |
|----------------|----------------|----------------------------------------|
| ![](andy-teucher.png) |     | **Andy Teucher** is an R Package Developer Educator at Posit.
...
He has a passion for teaching others to learn how to use data science tools to make their work more efficient and reproducible.
